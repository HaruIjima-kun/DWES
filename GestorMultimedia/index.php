...
<html>
    ...
    <body>
        <form action="pages/iniciarSesion.php" method="POST">
            ...
            <tbody>
                <?php foreach ($multimedias as $indice => $multimedia) { ?>
                    <tr>
                        ...
                        <!--<td>
                            <a class='borrar' href="phpdelete.php?ID=<?php /*$ciudad->getID()*/ ?>">Borrar</a>
                            <a href='viewedit.php?ID=<?php /*$ciudad->getID()*/ ?>'>Editar</a>
                        </td>-->
